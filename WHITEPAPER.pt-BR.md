...
|---------|--------|---------------|------------------------------|
| **Pagador (B2C ou MEI)** | Recebe boleto por e-mail, portal ou papel; nao e tecnico. | Confirmar em segundos se o titulo e autentico **antes** de pagar, sem conta no banco emissor. | Digita os **44 a 48 digitos** (ou usa o link da empresa); verifica na blockchain se o registro existe. |
...
O codigo de barras numerico tem **44 digitos**. A linha digitavel costuma ter **47 digitos** em boleto bancario ou **48** em boleto de concessionaria ou arrecadacao (layouts FEBRABAN). A validacao aceita **44 a 48 digitos** porque o pagador pode informar so o codigo de barras ou a linha digitavel completa. Essa sequencia e:
...
3. Digita os **44 a 48 numeros** da linha digitavel
