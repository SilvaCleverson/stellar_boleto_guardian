...
| ZXH_PRVKEY | C | 300 | **Nao utilizar para envio Ã  API.** A chave fica apenas no servidor da API. Campo mantido por compatibilidade; deixar em branco ou nao preencher. |
