# -*- coding: utf-8 -*-
"""Patch marketing copy for codebar length 44-47 digits (PT/EN/ES index)."""
...
def patch_index_pt(t: str) -> str:
    t = t.replace(
        ...
        "Valide em segundos com os 44 a 47 d\u00edgitos do c\u00f3digo de barras.",
    )
    t = t.replace(
        "valida\u00e7\u00e3o em segundos com os 47 d\u00edgitos.",
        "valida\u00e7\u00e3o em segundos com os 44 a 47 d\u00edgitos.",
    )
    t = t.replace(
        '<span class="badge">47 d\u00edgitos</span>',
        '<span class="badge">44\u201347 d\u00edgitos</span>',
    )
    t = t.replace(
        "valida em segundos com os <strong>47 d\u00edgitos</strong> da linha digit\u00e1vel",
        "valida em segundos com os <strong>44 a 47 d\u00edgitos</strong> do c\u00f3digo de barras ou da linha digit\u00e1vel",
    )
    t = t.replace("validar com os 47 d\u00edgitos", "validar com os 44 a 47 d\u00edgitos")
    t, n = re.subn(
        ...
        "<strong>entre 44 e 47 d\u00edgitos</strong>, conforme o padr\u00e3o FEBRABAN. A sequ\u00eancia \u00e9 \u00fanica por boleto, "
    ...
    t = t.replace(
        ...
        "<td><strong>C\u00f3digo de barras (44\u201347 d\u00edgitos)</strong></td>",
    )
    t = t.replace("Digita os 47 n\u00fameros.", "Digita os 44 a 47 n\u00fameros do c\u00f3digo de barras.")
    t = t.replace(
    ...
    t = t.replace(
        ...
        "O pagador consulta a valida\u00e7\u00e3o p\u00fablica (44 a 47 d\u00edgitos). Para <strong>registro e gest\u00e3o autenticados</strong>",
    )
    return t
...
def patch_index_en(t: str) -> str:
    t = t.replace(
        ...
        "Validate in seconds with 44 to 47 barcode digits.",
    )
    t = t.replace(
        "validate in seconds with the 47-digit barcode.",
        "validate in seconds with the 44\u201347-digit barcode.",
    )
    t = t.replace('<span class="badge">47 digits</span>', '<span class="badge">44\u201347 digits</span>')
    t = t.replace(
        "validates in seconds with the <strong>47-digit</strong> barcode, with no app",
        "validates in seconds with the <strong>44 to 47 digit</strong> barcode, with no app",
    )
    t = t.replace("validate with 47 digits", "validate with 44 to 47 digits")
    t, n = re.subn(
        ...
        "<p>A Brazilian bank slip numeric barcode has <strong>between 44 and 47 digits</strong>, per FEBRABAN layouts. "
    ...
    t = t.replace(
        ...
        "<td><strong>Barcode (44\u201347 digits)</strong></td>",
    )
    t = t.replace("3) Types the 47 digits.", "3) Types the 44 to 47 digits.")
    t = t.replace(
    ...
    t = t.replace(
        ...
        "The payer uses the public validation page (44 to 47 digits). For <strong>authenticated register and dashboard</strong>",
    )
    return t
...
def patch_index_es(t: str) -> str:
    t = t.replace(
        ...
        "Validaci\u00f3n en segundos con 44 a 47 d\u00edgitos del c\u00f3digo de barras.",
    )
    t = t.replace(
        "validaci\u00f3n en segundos con los 47 d\u00edgitos.",
        "validaci\u00f3n en segundos con los 44 a 47 d\u00edgitos.",
    )
    t = t.replace(
        '<span class="badge">47 d\u00edgitos</span>',
        '<span class="badge">44\u201347 d\u00edgitos</span>',
    ...
    t = t.replace(
        ...
        "valida en segundos con los <strong>44 a 47 d\u00edgitos</strong> del c\u00f3digo de barras o de la l\u00ednea digit\u00e1vel, sin app",
    )
    t = t.replace("validar con 47 d\u00edgitos", "validar con 44 a 47 d\u00edgitos")
    t, n = re.subn(
        ...
        "<strong>entre 44 y 47 d\u00edgitos</strong>, seg\u00fan el est\u00e1ndar FEBRABAN. La secuencia es \u00fanica por boleto, "
    ...
    t = t.replace("3) Digita los 47 n\u00fameros.", "3) Digita los 44 a 47 n\u00fameros del c\u00f3digo de barras.")
    t = t.replace(
    ...
    t = t.replace(
        ...
        "El pagador usa la p\u00e1gina p\u00fablica de validaci\u00f3n (44 a 47 d\u00edgitos). Para <strong>registro y panel autenticados</strong>",
    )
    return t
